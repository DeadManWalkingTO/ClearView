...
; Δεν γίνεται φόρτωση/αποθήκευση από INI ή άλλο εξωτερικό αρχείο.
...
class Settings {
    ...
    static ICON_NEUTRAL := "🔵"           ; ουδέτερο εικονίδιο για log (ή Chr(0x1F535))

    ; ------- Edge / Επιλογές εκτέλεσης -------
    static EDGE_WIN_SEL := "ahk_exe msedge.exe"     ; selector για λίστα/ενεργοποίηση παραθύρων
